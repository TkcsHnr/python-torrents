...
from utils import Torrent, EstoneURLs
import re
...
class EstoneParser(Parser):
    ...
    def get_torrents(self):
        torrent_boxes = self._soup.find_all("div", id=re.compile(r'torrent_\d+'))
        ...
        for box in torrent_boxes:
            ...
            download = EstoneURLs.DOWNLOAD.format(id=id, title=title)
    ...
    def get_page_count(self) -> int:
        ...
        last_page_tag = paginator.select_one(f'a:nth-last-child({nth_last_index})')
